...
if(isset($_POST['regBtn'])){
    ...
    if(empty($uvid))
    {
        $input_errors['uid'] = "ID field is Required.";
    }
    if(empty($phone))
    {
...
<html lang="en" class="fixed accounts sign-in">
    ...
    if(isset($input_errors['batch'])){ ?>
                                ...
                                <div class="form-group mt-md">
                                    <input type="text" class="form-control" placeholder="ID" name="uid" value="<?= isset($uvid) ?  $uvid : '' ?>">
                                    <?php 
    if(isset($input_errors['uid'])){ ?>
                                    <span class = "error-text"><?= $input_errors['uid'] ?></span>
                                    <?php }?>
                                </div>
                                <div class="form-group mt-md">
